...
WebDriverWait(driver, 10).until(
                EC.presence_of_element_located((By.XPATH,'//*[@id="content"]/div[1]/div[1]/div[2]/div/div[1]/div/div/div[1]/div[2]/div/div/div/ul/li[1]/div')))
...
try :
    ...
    while True:
        if (pageCnt > 1):
            WebDriverWait(driver, 10).until(
                EC.presence_of_element_located((By.CSS_SELECTOR, '#content > div.styled__Content-sc-1nnkzie-0.OjqKy > '
